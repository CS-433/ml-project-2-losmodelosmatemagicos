...
class BinaryClfScorer(Scorer):
    ...
    def _true_positive(
        self, y_true: list, y_pred: list, y_probs: list, demographics: list
    ):
        ...
        for demo in demos:
            try:
                indices = [
                    i for i in range(len(demographics)) if demographics[i] == demo
                ]
        ...
        for score in metrics:
            ...
            if score in self._score_dictionary:
                ...
                for demo in demos:
                    ...
                    scores[score][demo] = self._score_dictionary[score](
                        demo_true, demo_pred, demo_probs
                    )
        return scores

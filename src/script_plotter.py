...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--nonnested", dest="nonnested", default=False, action="store_true"
    )
    ...
    parser.add_argument(
        "--fairness", dest="fairness", default=False, action="store_true"
    )
    parser.add_argument(
        "--equalodds", dest="equal_odds", default=False, action="store_true"
    )
    ...
    parser.add_argument(
        "--dropstd", dest="drop_std", default=False, action="store_true"
    )
    parser.add_argument(
        "--filtering", dest="filtering", default=False, action="store_true"
    )

    # computation mode
    parser.add_argument("--overall", dest="overall", default=False, action="store_true")
    parser.add_argument(
        "--combined", dest="combined", default=False, action="store_true"
    )
    parser.add_argument("--fold", dest="fold", default=False, action="store_true")
    parser.add_argument(
        "--pairwise", dest="pairwise", default=False, action="store_true"
    )

    # Arguments
    parser.add_argument(
        "--show", dest="show", default=False, action="store_true"
    )  # image
    parser.add_argument(
        "--save", dest="save", default=False, action="store_true"
    )  # image
    parser.add_argument(
        "--dump", dest="dump", default=False, action="store_true"
    )  # csv
    parser.add_argument(
        "--print", dest="print", default=False, action="store_true"
    )  # csv
    parser.add_argument(
        "--display", dest="display", default=False, action="store_true"
    )  # csv
